...
public class EventoControlador{
    ...
    public ArrayList<String> getLocalidadesNoProp(){
        ArrayList<String> local = new ArrayList<>();
       for (Evento e : bd.getEventos())
           if(!e.getPropuesto() && e.getVisible() && !local.contains(e.getLocalidad()))
            local.add(e.getLocalidad());        
    ...
    public ArrayList<Date> getFechasNoProp(){
       ...
       for (Evento e : bd.getEventos())
           if(!e.getPropuesto() && e.getVisible() && !fechas.contains(e.getFecha_inicio()))
            fechas.add(e.getFecha_inicio());        
